...
export default class Fuse {
  ...
  static FUSE_POOL_DIRECTORY_CONTRACT_ADDRESS =
    networkMapping[currentNetwork].FUSE_POOL_DIRECTORY_CONTRACT_ADDRESS;

  static FUSE_SAFE_LIQUIDATOR_CONTRACT_ADDRESS =
    networkMapping[currentNetwork].FUSE_SAFE_LIQUIDATOR_CONTRACT_ADDRESS;

  static FUSE_FEE_DISTRIBUTOR_CONTRACT_ADDRESS =
    networkMapping[currentNetwork].FUSE_FEE_DISTRIBUTOR_CONTRACT_ADDRESS;

  static FUSE_POOL_LENS_CONTRACT_ADDRESS =
    networkMapping[currentNetwork].FUSE_POOL_LENS_CONTRACT_ADDRESS;

  static COMPTROLLER_IMPLEMENTATION_CONTRACT_ADDRESS =
    networkMapping[currentNetwork].COMPTROLLER_IMPLEMENTATION_CONTRACT_ADDRESS;

  static CERC20_DELEGATE_CONTRACT_ADDRESS =
    networkMapping[currentNetwork].CERC20_DELEGATE_CONTRACT_ADDRESS;

  static CETHER_DELEGATE_CONTRACT_ADDRESS =
    networkMapping[currentNetwork].CETHER_DELEGATE_CONTRACT_ADDRESS;

  static OPEN_ORACLE_PRICE_DATA_CONTRACT_ADDRESS =
    networkMapping[currentNetwork].OPEN_ORACLE_PRICE_DATA_CONTRACT_ADDRESS;

  static COINBASE_PRO_REPORTER_ADDRESS =
    networkMapping[currentNetwork].COINBASE_PRO_REPORTER_ADDRESS;

  static PUBLIC_PRICE_ORACLE_CONTRACT_ADDRESSES = networkMapping[currentNetwork].PUBLIC_PRICE_ORACLE_CONTRACT_ADDRESSES;

  static DAI_POT = networkMapping[currentNetwork].DAI_POT;
  static DAI_JUG = networkMapping[currentNetwork].DAI_JUG;

  static UNISWAP_V2_FACTORY_ADDRESS =
    networkMapping[currentNetwork].UNISWAP_V2_FACTORY_ADDRESS;

  static UNISWAP_V2_PAIR_INIT_CODE_HASH =
    networkMapping[currentNetwork].UNISWAP_V2_PAIR_INIT_CODE_HASH;

  static WETH_ADDRESS = networkMapping[currentNetwork].WETH_ADDRESS;

  static PRICE_ORACLE_RUNTIME_BYTECODE_HASHES = networkMapping[currentNetwork].PRICE_ORACLE_RUNTIME_BYTECODE_HASHES;
  ...
  static PUBLIC_INTEREST_RATE_MODEL_CONTRACT_ADDRESSES = networkMapping[currentNetwork].PUBLIC_INTEREST_RATE_MODEL_CONTRACT_ADDRESSES;

  // networkSwitcher(currentNetwork);
